    ...
    <>
      ...
      <section className="py-16 px-6 sm:px-12 lg:px-16 max-w-5xl mx-auto text-neutral-800 leading-relaxed space-y-8">
        ...
        <div className="space-y-8 pt-4">
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">1. Website Information</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">2. Membership</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">3. Membership Benefits</h2>
            <p className="text-sm text-neutral-600 leading-relaxed mb-2">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">4. Bookings</h2>
            <p className="text-sm text-neutral-600 leading-relaxed mb-2">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">5. Vouchers and Certificates</h2>
            <p className="text-sm text-neutral-600 leading-relaxed mb-2">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">6. Payments</h2>
            <p className="text-sm text-neutral-600 leading-relaxed mb-2">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">7. Cancellation and Refunds</h2>
            <p className="text-sm text-neutral-600 leading-relaxed mb-2">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">8. Third-Party Services</h2>
            <p className="text-sm text-neutral-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">9. Intellectual Property</h2>
            <p className="text-sm text-neutral-600 leading-relaxed mb-2">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">10. Prohibited Use</h2>
            <p className="text-sm text-neutral-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">11. Changes to Services and Terms</h2>
            <p className="text-sm text-neutral-600 leading-relaxed mb-2">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">12. Limitation of Liability</h2>
            <p className="text-sm text-neutral-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">13. Privacy</h2>
            <p className="text-sm text-neutral-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">14. Governing Law</h2>
            <p className="text-sm text-neutral-600 leading-relaxed">
          ...
          <div className="pt-6 border-t border-neutral-200">
            <h2 className="text-xl sm:text-2xl font-[Vera] text-[#B38E46] mb-3">15. Contact</h2>
