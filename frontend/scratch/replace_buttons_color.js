...
walkDir(targetDir, function(filePath) {
  ...
  if (['.tsx', '.ts', '.jsx', '.js', '.css', '.json'].includes(ext)) {
    ...
    let updated = content
      ...
      .replace(/rgba\(91,\s*0,\s*45/gi, 'rgba(227,159,37')
      .replace(/#c9891c/gi, '#c9891c') // hover shade
      .replace(/#c9891c/gi, '#c9891c');
...
console.log(`Total files updated for button color #E39F25: ${count}`);
