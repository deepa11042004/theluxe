      ...
      <div className="max-w-4xl mx-auto text-center px-6 md:px-12 z-10 relative flex flex-col items-center">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="border border-[#E39F25] bg-transparent text-white px-8 py-3.5 text-xs tracking-[0.25em] font-medium uppercase hover:bg-[#E39F25] hover:text-white transition-all duration-300 cursor-pointer rounded-sm"
          >
            EXPLORE VACATIONS
          </motion.button>
        </motion.div>
