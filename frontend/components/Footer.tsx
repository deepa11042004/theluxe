...
export default function Footer() {
  return (
    <footer
      className="text-white pt-16 pb-8 px-6 sm:px-12 lg:px-16 w-full select-none border-t border-[#B38E46] relative overflow-hidden bg-[#B38E46]"
      style={{
        fontFamily: "var(--work-font), sans-serif",
        backgroundImage:
          "linear-gradient(to bottom, rgba(160, 120, 45, 0.75), rgba(110, 80, 20, 0.85)), url('/Img/gold-texture.jpg')",
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col items-center justify-center text-center pb-8 border-b border-white/20">
          ...
          <p className="mt-4 text-xs sm:text-sm text-white/90 max-w-md font-light tracking-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 flex flex-col gap-3">
            ...
            <div className="space-y-1.5 text-xs text-white/90 pt-2 font-light">
              <p><span className="font-semibold text-white">Phone:</span> +1 (800) 000-0000</p>
              <p><span className="font-semibold text-white">Email:</span> info@example.com</p>
              <p><span className="font-semibold text-white">Address:</span> 123 Luxury Way, Suite 100</p>
            </div>
          </div>
              ...
              <ul className="space-y-2">
                {section.links.map((link, lIdx) => (
                  <li key={lIdx}>
                    <a
                      href={link.href}
                      className="text-xs sm:text-sm text-white/85 hover:text-white hover:underline transition-colors font-light"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        <div className="border-t border-white/20 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/80 font-light">
          ...
          <div className="flex gap-6">
            ...
            <a href="#" className="hover:underline hover:text-white transition-colors">Terms of Service</a>
            <a href="#" className="hover:underline hover:text-white transition-colors">Cookie Settings</a>
          </div>
        </div>
      </div>
    </footer>
