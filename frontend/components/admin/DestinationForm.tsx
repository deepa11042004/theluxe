    ...
    <div className="space-y-6 max-w-full">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-xs">
        ...
        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto justify-end">
          ...
          <button type="button" onClick={() => handleSubmit("PUBLISHED")} disabled={loading} className="px-4 sm:px-5 py-2 bg-[#E39F25] text-white rounded-xl text-xs font-semibold hover:bg-[#430021] flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="bg-[#E39F25] text-white px-4 py-2 rounded-xl text-xs font-semibold hover:bg-[#430021]"
                >
                  Add Image
                </button>
              </div>
