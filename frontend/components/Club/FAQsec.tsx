              ...
              >
                ...
                >
                  <div className="flex items-center gap-4 md:gap-6 pr-4">
                    <span className="text-xs md:text-sm font-[Vera] font-bold shrink-0 text-[#E39F25]">
                      {faq.number}.
                    </span>
                    <span
                      className={`text-base md:text-lg font-[Vera] font-semibold transition-colors ${
                        isOpen
                          ...
                          : "text-neutral-900 group-hover:text-[#E39F25]"
                      }`}
                    >
                      {faq.question}
                    </span>
                  ...
                  <motion.div
                    ...
                    className="shrink-0 ml-4 p-1 text-[#E39F25]"
                  >
